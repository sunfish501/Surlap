            ...
            children: [
              CategoryFilterChip(
                ...
                onTap: () {
                  ...
                  if (hidden.isEmpty) {
                    f.setAll([holidayThemeId, ...themes.map((t) => t.id)]);
                  } else {
                    f.clear();
                  }
                },
              ...
              CategoryFilterChip(
                ...
                sh: sh,
                onTap: () =>
                    ref.read(filterProvider.notifier).toggle(holidayThemeId),
              ),
          ...
          child: Column(
            children: [
              ...
              SettingsRow(
                ...
                title: tr('개인정보 처리방침'),
                onTap: () =>
                    _openUrl('https://kev208dev.github.io/Surlap/privacy.html'),
              ),
              SettingsRow(
                sh: sh,
                ...
                title: tr('이용약관'),
                onTap: () =>
                    _openUrl('https://kev208dev.github.io/Surlap/terms.html'),
              ),
            ],
          ),
        ),
            ...
            child: Row(
              children: [
                ...
                Text(
                  ...
                  style: AppType.bodyLarge.copyWith(
                    color: sh.ink,
                    fontWeight: l == lang ? FontWeight.w700 : FontWeight.w400,
                  ),
                ),
              ],
            ),
        ...
        for (final e in _labels.entries)
          PopupMenuItem(
            ...
            child: Text(
              ...
              style: AppType.bodyLarge.copyWith(
                color: sh.ink,
                fontWeight: e.key == dow ? FontWeight.w700 : FontWeight.w400,
              ),
            ),
          ),
      ],
        ...
        for (final h in _opts)
          PopupMenuItem(
            ...
            child: Text(
              ...
              style: AppType.bodyLarge.copyWith(
                color: sh.ink,
                fontWeight: h == hour ? FontWeight.w700 : FontWeight.w400,
              ),
            ),
          ),
      ],
        ...
        for (final m in _opts)
          PopupMenuItem(
            ...
            child: Text(
              ...
              style: AppType.bodyLarge.copyWith(
                color: sh.ink,
                fontWeight: m == minutes ? FontWeight.w700 : FontWeight.w400,
              ),
            ),
          ),
      ],
